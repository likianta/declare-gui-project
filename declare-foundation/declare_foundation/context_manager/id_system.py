...
class IdManager:
    ...
    def set(self, qid: T.Uid, comp: T.Component):
    ...
    def get_component(self, qid: T.Uid) -> T.Component:
        return self._tile_struct[qid]
    
    def get_children(self, qid: T.Uid) -> T.UidList:
